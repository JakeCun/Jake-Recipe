    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cusine_types', models.CharField(choices=[('african', 'African'), ('american', 'American'), ('caribbean', 'Caribbean'), ('asian', 'Asian'), ('middle_eastern', 'Middle Eastern'), ('chinese', 'Chinese'), ('indian', 'Indian'), ('pakistani', 'Pakistani'), ('indonesian', 'Indonesian'), ('european', 'European'), ('oceanic', 'Oceanic')], default='african', max_length=50)),
